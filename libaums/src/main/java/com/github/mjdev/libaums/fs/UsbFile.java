...
public interface UsbFile extends Closeable {
   ...
   * @throws IOException If new name is already assigned or writing to the file system fails.
   */
   ...
   * @throws IOException If writing fails, or the operation cannot be done (eg. item already exists
