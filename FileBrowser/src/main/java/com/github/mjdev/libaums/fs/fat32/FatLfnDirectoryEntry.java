...
/* package */class FatLfnDirectoryEntry {
	...
	/**
	 * The actual entry which holds information like the start cluster and the file size.
	 */
	private FatDirectoryEntry actualEntry;
	/**
	 * The long file name or null if the actual entry does not have a long file name.
	 */
