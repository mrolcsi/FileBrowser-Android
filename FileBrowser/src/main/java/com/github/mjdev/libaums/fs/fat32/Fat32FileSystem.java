...
public class Fat32FileSystem implements FileSystem {
	...
	/**
	 * This method constructs a FAT32 file system for the given block device. There are no further
	 * checks that the block device actually represents a valid FAT32 file system. That means it must
